...
- 모니터링/알림 개요: qmtl/docs/operations/monitoring.md
- Seamless SLA 대시보드: qmtl/docs/operations/seamless_sla_dashboards.md
...
- Helm/Terraform로 Jsonnet 번들 배포를 원하면 qmtl/docs/operations/monitoring.md의 “Jsonnet packaging automation” 절차를 수행
...
자세한 참조: qmtl/docs/operations/monitoring.md의 “Alert Rules”, “SDK Metrics” 섹션
...
- 문서: qmtl/docs/operations/seamless_sla_dashboards.md
- 구성: Jsonnet → Helm/Terraform로 프로비저닝 (qmtl/docs/operations/monitoring.md 참조)
...
- qmtl/docs/operations/monitoring.md의 Helm/Terraform 절차를 사용해 ConfigMap으로 자동 배포
