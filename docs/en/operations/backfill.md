...
- **`worker`** – populated from `connectors.seamless_worker_id`, `connectors.worker_id`, or the container hostname. Configure one of these values in production to keep dashboards consistent.
