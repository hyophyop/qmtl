...
## Examples
- `docs/en/architecture/README.md` → `tags: [architecture, overview]`
- `docs/en/guides/README.md` → `tags: [guide, overview]`
- `docs/en/operations/README.md` → `tags: [operations, overview]`
