...
- Implementation status and evolution are tracked in `seamless_data_provider_v2.md` and `../design/rewrite_architecture_docs.md` from a Core Loop alignment perspective.
