...
from .core_loop_hub import CoreLoopHub, deep_merge_mappings, derive_metrics_from_risk_snapshot
...
class WorldService:
    ...
    def __init__(
        ...
        self._activation = ActivationEventPublisher(
            store,
            bus,
            risk_hub=risk_hub,
    ...
    def _metrics_from_risk_snapshot(
        ...
        *,
        ...
        return derive_metrics_from_risk_snapshot(
            snapshot,
    ...
    async def _ensure_metrics_for_evaluate(self, world_id: str, payload: EvaluateRequest) -> None:
        ...
        if base_metrics and hub_metrics:
            derived = deep_merge_mappings(base_metrics, hub_metrics)
        else:
