...
_EXTENDED_API: Mapping[str, tuple[str, str | None]] = {
    ...
    "AlignedPayload": ("qmtl.runtime.sdk.temporal", "AlignedPayload"),
    "AlignedView": ("qmtl.runtime.sdk.temporal", "AlignedView"),
    "AlignmentInputSpec": ("qmtl.runtime.sdk.temporal", "AlignmentInputSpec"),
    "AlignmentStatus": ("qmtl.runtime.sdk.temporal", "AlignmentStatus"),
    "CalendarSpec": ("qmtl.runtime.sdk.temporal", "CalendarSpec"),
    "JoinSpec": ("qmtl.runtime.sdk.temporal", "JoinSpec"),
    "TemporalAlignedOutputSpec": (
        "qmtl.runtime.sdk.temporal",
        "TemporalAlignedOutputSpec",
    ),
    "TemporalSpec": ("qmtl.runtime.sdk.temporal", "TemporalSpec"),
    "TriggerSpec": ("qmtl.runtime.sdk.temporal", "TriggerSpec"),
    "WatermarkPolicy": ("qmtl.runtime.sdk.temporal", "WatermarkPolicy"),
    "align_temporal": ("qmtl.runtime.sdk.temporal", "align_temporal"),
    "infer_join_specs": ("qmtl.runtime.sdk.temporal", "infer_join_specs"),
