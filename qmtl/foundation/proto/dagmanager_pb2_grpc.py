...
if _version_not_supported:
    raise RuntimeError(
        ...
        + ' but the generated code in dagmanager_pb2_grpc.py depends on'
...
class DiffServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Diff = channel.unary_stream(
                '/qmtl.services.dagmanager.DiffService/Diff',
        ...
        self.AckChunk = channel.unary_unary(
                '/qmtl.services.dagmanager.DiffService/AckChunk',
...
def add_DiffServiceServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'qmtl.services.dagmanager.DiffService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('qmtl.services.dagmanager.DiffService', rpc_method_handlers)
...
class TagQueryStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetQueues = channel.unary_unary(
                '/qmtl.services.dagmanager.TagQuery/GetQueues',
...
def add_TagQueryServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'qmtl.services.dagmanager.TagQuery', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('qmtl.services.dagmanager.TagQuery', rpc_method_handlers)
...
class AdminServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Cleanup = channel.unary_unary(
                '/qmtl.services.dagmanager.AdminService/Cleanup',
        ...
        self.GetQueueStats = channel.unary_unary(
                '/qmtl.services.dagmanager.AdminService/GetQueueStats',
        ...
        self.RedoDiff = channel.unary_unary(
                '/qmtl.services.dagmanager.AdminService/RedoDiff',
...
def add_AdminServiceServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'qmtl.services.dagmanager.AdminService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('qmtl.services.dagmanager.AdminService', rpc_method_handlers)
...
class HealthCheckStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Status = channel.unary_unary(
                '/qmtl.services.dagmanager.HealthCheck/Status',
...
def add_HealthCheckServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'qmtl.services.dagmanager.HealthCheck', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('qmtl.services.dagmanager.HealthCheck', rpc_method_handlers)
